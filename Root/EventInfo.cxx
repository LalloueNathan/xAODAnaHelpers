      ...
      if ( m_storeSyst ) {
        ...
        for( const auto *truthEvent : *truthEvents){
        	xAOD::TruthEvent::PdfInfo pdf_info = truthEvent->pdfInfo();
            	for (size_t iPDF = 0; iPDF < pdfs_1.size(); iPDF++){
              		double pdf_weight = LHAPDF::weightxxQ2( pdf_info.pdgId1, pdf_info.pdgId2, pdf_info.x1, pdf_info.x2, pdf_info.Q, pdfs_1.at(0), pdfs_1.at(iPDF) );
